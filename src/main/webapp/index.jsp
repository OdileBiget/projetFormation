...
<body>
			...
			<div class="form-inline my-2 my-lg-0" id="buttonNavBar">
				...
				<div>
					...
					<%-- <c:if test="${log == true }">
						...
						<a href="<%=request.getContextPath() + "/Deconnexion"%>"><button
								class="btn btn-outline-success my-2 my-sm-0" type="submit"
								name="deconnexion">Déconnexion</button></a>
					...
					<c:if test="${log != true }">
						...
						<a href="connexion.jsp"><button
								class="btn btn-outline-success my-2 my-sm-0" type="submit"
								name="connexion">Connexion</button></a>
	...
	<!--  Footer -->
	<footer
		class="page-footer font-small mdb-color darken-3 pt-4 navbar-light"
				...
				<div class="col-md-6">
					...
					<div class="embed-responsive embed-responsive-16by9 mb-4">
						<iframe width="560" height="315"
							src="https://www.youtube.com/embed/J3euEMWC8tg" frameborder="0"
		...
		<div class="footer-copyright text-center py-3">
			© 2020 Copyright: <a href="https://www.nationalgeographic.fr/">The
				Wildlife of Nature</a>
		</div>
		<!-- Copyright -->
